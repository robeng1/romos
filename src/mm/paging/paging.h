...
int paging_map_virtual_to_physical_addresses(struct paging_4GB_chunk_t *directory, void *virtual_addr, void *physical_addr, void *physical_addr_end, int flags);
